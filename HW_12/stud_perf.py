...
class Validate:
    "Дескриптор проверки ФИО на наличие первой заглавной буквы, а также что ФИО состоит только из букв"
...
class Student:
    ...
    def lessons(self, lessons_file: Path):
        "Декоратор считывающий из файла список предметов в словарь lessons"
    ...
    def __call__(self, lesson: str, number: int, type_est: str = "lesson"):
        "Сохранение новой оценки по предмету/тесту"
    ...
    def calculate_middle_test(lessons: dict) -> float:
        "Средний бал по тестам по всем предметам"
...
if __name__ == '__main__':
    student_1 = Student("Иван", "Иванович", "Иванов", Path('lessons.csv'))
    student_1("русский язык", 3)
    student_1("русский язык", 5)
    student_1("русский язык", 5)
    student_1("физика", 4)
    student_1("физика", 5)
    student_1("физика", 55, "test")
    student_1("математика", 5)
    student_1("математика", 4)
    student_1("математика", 5)
    student_1("информатика", 55, "test")
    student_1("математика", 95, "test")
    student_1("история", 80, "test")
    student_1("история", 5)
    ...
    student_1("информатика", 60, "test")
    print(student_1)

    student_2 = Student("Петр", "Петрович", "Петров", Path('lessons.csv'))
    student_2("русский язык", 4)
    student_2("русский язык", 3)
    student_2("русский язык", 5)
    student_2("история", 5)
    student_2("история", 4)
    student_2("физика", 3)
    student_2("физика", 4)
    student_2("математика", 5)
    student_2("математика", 4)
    student_2("математика", 65, "test")
